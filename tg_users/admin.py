...
from tg_users.models import TgUser, WebhookMessage
...
class UserAdmin(admin.ModelAdmin):
    ...
    #     """ Select tg_users via check mark in django-admin panel, then select "Broadcast" to send message"""
    ...
    #                 )
    #             self.message_user(request, f"Just broadcasted to {len(queryset)} tg_users")
    #         else:
